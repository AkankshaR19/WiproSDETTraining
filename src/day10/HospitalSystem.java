...
public static void main(String[] args) {
	...
	patients.add(new HospitalSystem(101, "Aman"));
	patients.add(new HospitalSystem(102, "Amy"));
	patients.add(new HospitalSystem(103, "Aksh"));
	patients.add(new HospitalSystem(103, "Akshat"));
